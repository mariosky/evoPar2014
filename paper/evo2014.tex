...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{eps/plot_time_CRS__w4.eps}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{eps/plot_time_CRS__w8.eps}
\caption{Time required to solution, Random Insertion}
...
\begin{figure}[!t]
\centering
\includegraphics[width=3.5in]{eps/plot_time_CRS__w16.eps}
\caption{Time required to solution, Random Insertion}
